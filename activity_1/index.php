<?php 
  ...
  $sql2 = "SELECT id,first_name,last_name FROM users";
              ...
              <table class="display table table-bordered users" width="100%" id="dataTable" cellspacing="0">
                ...
                <tbody>
                  <?php foreach($result as $row){ ?>
                    <?php $gender = ($row['gender'] == 1) ? "Male" : "Female"; ?>
                    <?php $date1 = date_create($row['birthday']); ?>
                    ...
                    <tr>
                      ...
                      <td><?php echo date_format($date1,'y/m/d'); ?></td>
